export default function TabMenu(props) {
  ...
  return (
    <div className="w-full bg-neutral-700 flex justify-center hidden-print">
      <ul className="w-10/12 flex gap-2 md:gap-8 pt-10 px-5 ">
        <li
          id="ingreso"
          onClick={() => changeView("ingreso")}
          className="cursor-pointer bg-white px-3 md:px-7 md:h-10 text-center items-center flex text-normal md:text-xl rounded-t-md"
        >
          Ingreso
        </li>
        <li
          ...
          className="cursor-pointer bg-neutral-400 px-3 md:px-7 md:h-10 text-center items-center flex text-normal md:text-xl rounded-t-md"
        >
          Agregar
        </li>
        <li
